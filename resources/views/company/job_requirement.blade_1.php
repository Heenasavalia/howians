                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12 mb-12">
                                        ...
                                        <div class="form-row">
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" placeholder="Min. Salary" name="minimum_salary">
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                <input type="text" class="form-control" placeholder="Max. Salary" name="maximum_salary">
                                            </div>
                                        </div>
                                        <div class="form-group">
