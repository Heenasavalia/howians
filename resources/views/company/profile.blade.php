                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group{{ $errors->has('profile_image') ? ' has-error' : '' }}">
                                        ...
                                        @if(Auth::user()->company_profile !== null)
                                            <img class="img_size" src="{{ config('constants.company_profile') . Auth::user()->profile_image }}">
                                        @endif
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="{{ $errors->has('email') ? ' has-error' : '' }} row">
                                        ...
                                        <div class="col-sm-9 form-group">
                                            <input id="email" type="text" class="form-control" name="email" value="{{ Auth::user()->email}}" placeholder="Email">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="{{ $errors->has('mobile') ? ' has-error' : '' }} row">
                                        ...
                                        <div class="col-sm-9 form-group">
                                            <input id="mobile" type="text" class="form-control" name="mobile" value="{{ Auth::user()->mobile}}" placeholder="Mobile">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="{{ $errors->has('company_name') ? ' has-error' : '' }} row">
                                        ...
                                        <div class="col-sm-9 form-group">
                                            <input readonly id="company_name" type="text" class="form-control" name="company_name" value="{{ Auth::user()->company_name}}" placeholder="Company name">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="{{ $errors->has('address') ? ' has-error' : '' }} row">
                                        ...
                                        <div class="col-sm-9 form-group">
                                            <input id="address" type="text" class="form-control" name="address" onFocus="geolocate()" value="{{ Auth::user()->address}}" placeholder="Address">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <input id="send" type="submit" class="btn btn-primary btn-block" value="Update">
                                        </div>
                                    </div>
                                </div>
                            </div>
