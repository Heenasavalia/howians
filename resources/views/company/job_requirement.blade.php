                                                ...
                                                <form class="wizard-form" id="design-wizard" action="#">
                                                    ...
                                                    <fieldset>
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <label for="job-title" class="block">Job Title</label>
                                                            </div>
                                                            <div class="col-sm-12">
                                                        ...
                                                        <div class=" form-group row">
                                                            ...
                                                            <label class="col-sm-2 col-form-label" for="type-of-job">Type of job</label>
                                                            <div class="col-sm-10">
                                                                <div class="border-checkbox-section">
                                                                    <div class="border-checkbox-group border-checkbox-group-primary">
                                                                        <input class="border-checkbox" type="checkbox"  name="job_type[]" id="part_time">
                                                                        <label class="border-checkbox-label" for="part_time">Part time</label>
                                                                    </div>
                                                                    <div class="border-checkbox-group border-checkbox-group-primary">
                                                                        <input class="border-checkbox" type="checkbox"  name="job_type[]" id="full_time">
                                                                        <label class="border-checkbox-label" for="full_time">Full time</label>
                                                                    </div>
                                                                    <div class="border-checkbox-group border-checkbox-group-primary">
                                                                        <input class="border-checkbox" type="checkbox"  name="job_type[]" id="freelacer">
                                                                        <label class="border-checkbox-label" for="freelacer">Freelacer</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <label for="type-of-job" class="block">Salary</label>
                                                            </div>
                                                            <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select name="select" class="form-control" name="education">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label" for="experiance-required">Experiance required</label>
                                                            <div class="col-sm-10">
                                                                <div class="form-radio">
                                                                    <div class="radio radio-inline">
                                                                        <label>
                                                                            <input type="radio" name="work_experiance_type" checked="checked" id="fresher" value="fresher">
                                                                            <i class="helper"></i>Fresher
                                                                        </label>
                                                                    </div>
                                                                    <div class="radio radio-inline">
                                                                        <label>
                                                                            <input type="radio" name="work_experiance_type" id="experienced" value="experienced">
